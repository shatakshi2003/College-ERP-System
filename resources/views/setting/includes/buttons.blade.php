<div class="clearfix hidden-print " >
    <div class="easy-link-menu align-left">
        ...
        <a class="{!! request()->is('setting/payment-gateway')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('setting.payment-gateway') }}"><i class="fa fa-dollar" aria-hidden="true"></i></a>
        <a class="{!! request()->is('setting/meeting')?'btn-success':'btn-primary' !!} btn-sm " href="{{ route('setting.meeting') }}"><i class="fa fa-video-camera" aria-hidden="true"></i></a>
